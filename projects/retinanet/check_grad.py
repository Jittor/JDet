...
def main():
    ...
    if (run_ours):
        os.system(f"CUDA_VISIBLE_DEVICES=3 python run_net.py --config-file=configs/retinanet_4.py --use_cuda --task=train")

    ours_weights_path = '/mnt/disk/cxjyxx_me/JAD/JDet/projects/retinanet/exp/retinanet_4/checkpoints/ckpt_1.pkl'
    yx_weights_path = 'cache_check/i1.pk_jt.pk'
    check_diff(ours_weights_path, yx_weights_path)

    # ours_weights_path = '/mnt/disk/cxjyxx_me/JAD/JDet/projects/retinanet/exp/retinanet_4/checkpoints/ckpt_0.pkl'
