...
def main():
    ...
    init_cfg("projects/h2rbox/configs/h2rbox_test.py")
    cfg = get_cfg()
    ...
    if (args.set_data):
        ...
        if (not os.path.exists("test_datas_h2rbox")):
            os.makedirs("test_datas_h2rbox")
        pk.dump(data, open("test_datas_h2rbox/test_data.pk", "wb"))
        print(correct_loss)
    else:
        data = pk.load(open("test_datas_h2rbox/test_data.pk", "rb"))
