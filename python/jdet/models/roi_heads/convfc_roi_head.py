...
class ConvFCRoIHead(BaseRoIHead):
    ...
    def __init__(self,
                 ...
                 norm_cfg=None,
                 **kwargs):
        super(ConvFCRoIHead, self).__init__(**kwargs)
    ...
    def _add_conv_fc_branch(self,
        ...
        if num_branch_convs > 0:
            for i in range(num_branch_convs):
                ...
                branch_convs.append(
                    nn.Conv(            #TODO: use ConvModule instead of nn.Conv
                        conv_in_channels,
    ...
    def _init_layers(self):
        ...
        if self.with_reg:
            out_dim_reg = (self.reg_dim if self.reg_class_agnostic else self.reg_dim *
                           self.num_classes)
...
@HEADS.register_module()
class SharedConvFCRoIHead(ConvFCRoIHead):

    def __init__(self, num_fcs=2, fc_out_channels=1024, *args, **kwargs):
        assert num_fcs >= 1
        super(SharedConvFCRoIHead, self).__init__(
            num_shared_convs=0,
