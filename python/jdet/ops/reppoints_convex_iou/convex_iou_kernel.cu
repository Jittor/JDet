// https://github.com/hukaixuan19970627/OrientedRepPoints_DOTA/blob/258d7925a8bc8a364c1c53bc515b6912d9d296db/mmdet/ops/iou/src/convex_iou_kernel.cu
#include <vector>
#include <algorithm>
#include <math.h>
#include <stdio.h>
...
__global__ void convex_iou_kernel(const int ex_n_boxes, const int gt_n_boxes,
                            const float *ex_boxes, const float *gt_boxes, float* iou){
